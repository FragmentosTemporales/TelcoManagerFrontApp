...
function Home() {
  ...
  const secciones = [
    ...
    {
      head: "LOGISTICA / Gestión Bodega Quinta",
      title: "Espacio para gestión de atención en bodega de la V Región",
      link: "/bodegaQuinta",
      moduloID: 12,
    },
    {
      head: "OPERACIONES / Gestión Supervisor",
