...
import { fetchDetalleOrdenNoConsumidaSinStock } from "../api/ndcAPI";
...
function NDCOrdenConConsumoSinStockView() {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetchDetalleOrdenNoConsumidaSinStock(orden);
            setData(response || []);
...
export default NDCOrdenConConsumoSinStockView;
